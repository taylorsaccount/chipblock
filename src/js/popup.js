...
function refreshPopup() {
  ...
  if (!POPUP_DATA.enabled) {
    ...
    $("#privacy-badger-header").addClass("faded-bw-color-scheme");
    $("#badger-header-logo").attr("src", "../icons/icon-disabled.png");
  } else {
    $("#privacy-badger-header").removeClass("faded-bw-color-scheme");
    $("#badger-header-logo").attr("src", "../icons/icon.png");
  }
